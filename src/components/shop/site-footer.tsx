    ...
    <footer className="mt-12 border-t bg-muted/40">
      <div className="container py-8">
        ...
        <p className="mt-3 max-w-md text-sm text-muted-foreground">
          Wholesale &amp; retail kirana supplier. Browse products, build your order and
          send it to us on WhatsApp — we&apos;ll handle delivery.
        </p>
        ...
        <nav className="mt-5 flex flex-wrap gap-x-5 gap-y-2 text-sm font-medium">
          <Link href="/retail" className="hover:text-primary">Retail</Link>
        ...
        <p className="mt-6 text-xs text-muted-foreground">
          © {new Date().getFullYear()} Ganesh Trading Company. All rights reserved.
        </p>
      </div>
    </footer>
  );
